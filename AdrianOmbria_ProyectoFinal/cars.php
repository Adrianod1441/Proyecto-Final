...
<body>
    ...
    <section class="search-results">
        <h2 class="heading">buscar resultados por <span>coches</span></h2>

        <!-- productos -->
        <div class="product-containerr" style="grid-template-columns: repeat(3, 1fr);">
        <?php 
            include "php/listaJuguetes.php";
            $numeroJuguetes = contarJuguetesTipo("Coche");
            $numerPaginas = ceil($numeroJuguetes / tamanoPaginas);
            $lista = obtenerListaJuguetes("Coche",true,$_GET["paginaActual"]); 
            foreach($lista as $p):
        ?>
            ...
            <?php
                    if ($numeroJuguetes <= tamanoPaginas || $_GET["paginaActual"] == $numerPaginas){
                        ...
                        echo '<a href="cars.php?paginaActual='; echo $_GET["paginaActual"] + 1; echo'" class="nxt-btn" style="width: 50px; height: 50px; top:700px;"><img src="img/arrow.png" alt=""></a>';
                    }
                    ...
                    if ($numeroJuguetes <= tamanoPaginas || $_GET["paginaActual"] == 1){
                        ...
                        echo '<a href="cars.php?paginaActual='; echo $_GET["paginaActual"] - 1; echo'" class="pre-btn" style=" height: 50px; top:700px;"><img src="img/arrow.png" alt=""></a>';
                    }
                ?>
        </div>
    </section>
